Decoherence is a free and opensource phase-based RPG in the mood of Wizardry 8 in hard sci-fi setting written in Lazarus/FreePascal and Castle Game Engine.

Compiles to: Windows, Linux, Android


At this momemt most of the game content is available only in Russian, but I will eventually translate everything into English too... This fact is determined by an existing Russian Wizardry-8 fans community. If you wish to include English transiation as a priority task, please, write me you also wait for this game asap :) and support the development just by being interested in it :)
