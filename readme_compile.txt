...
This version requires Castle Game Engine to compile (at least 6.0 version / 01.03.2017). You can download it here https://github.com/castle-engine/castle-engine and follow installation instructions here http://castle-engine.sourceforge.net/tutorial_install.php
