...
begin
  ...
  for i := 0 to maxparty do begin
    if not odd(i) then
      PartyBars[i].setbasesize(0,(1+(maxparty-i+1) div 2*3)/17,0.5/17,3/17,1,animate)
    else
      PartyBars[i].setbasesize(-0.5/17,(1+(maxparty-i+1) div 2*3)/17,0.5/17,3/17,1,animate);
    PartyBars[i].rescale;
  end;
  ...
  for i := 0 to maxparty do begin
    if not odd(i) then
      portraits[i].setbasesize(0.5/17,(1+(maxparty-i+1) div 2*3)/17,2.5/17,3/17,1,animate)
    else
      portraits[i].setbasesize(-3/17,(1+(maxparty-i+1) div 2*3)/17,2.5/17,3/17,1,animate);
    portraits[i].rescale;
  end;
end;
